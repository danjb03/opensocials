...
export const mockCreatorsBase: Creator[] = [
  ...
  { id: 4, name: 'Taylor Singh', platform: 'instagram', audience: 'millennials', contentType: 'photo', followers: '80K', engagement: '3.2%', priceRange: '$300-800', skills: ['travel', 'photography', 'food'], imageUrl: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80' },
  { id: 5, name: 'Morgan Lee', platform: 'twitter', audience: 'gen-x', contentType: 'blog', followers: '45K', engagement: '2.8%', priceRange: '$250-600', skills: ['writing', 'opinion', 'news'], imageUrl: 'https://images.unsplash.com/photo-1581092795360-fd1ca04f0952?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80' },
