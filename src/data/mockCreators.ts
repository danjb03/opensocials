...
export const mockCreatorsBase: Creator[] = [
  ...
  { id: 4, name: 'Taylor Singh', platform: 'instagram', audience: 'millennials', contentType: 'photo', followers: '80K', engagement: '3.2%', priceRange: '$300-800', skills: ['travel', 'photography', 'food'], imageUrl: 'https://images.unsplash.com/photo-1619895862022-09114b41f16f?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80' },
