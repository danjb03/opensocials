...
const BrandOrders = () => {
  ...
  const getStageColor = (stage: string) => {
    switch (stage) {
      case 'campaign_setup': return 'bg-gray-100 text-gray-800';
      case 'awaiting_submissions': return 'bg-blue-100 text-blue-800';
      case 'reviewing_content': return 'bg-yellow-100 text-yellow-800';
      case 'ready_to_launch': return 'bg-green-100 text-green-800';
  ...
  const getStageText = (stage: string) => {
    switch (stage) {
      case 'campaign_setup': return 'Setup';
      case 'awaiting_submissions': return 'Awaiting Content';
      case 'reviewing_content': return 'Under Review';
            ...
            {campaignsByStage.review.length > 0 ? (
              ...
              <Card>
                <CardContent className="pt-6 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No Campaigns Under Review</h3>
            ...
            {campaignsByStage.live.length > 0 ? (
              ...
              <Card>
                <CardContent className="pt-6 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No Live Campaigns</h3>
