...
export const StatCard = ({
  ...
  return (
    ...
    >
      <div className="w-full h-[360px] rounded-2xl border border-white/20 
        ...
        {/* Icon with enhanced blue accent - reduced top margin */}
        <div className="relative z-20 mt-6 ml-6 mb-4 p-3 rounded-xl 
          ...
          <Icon size={24} className="text-blue-100 group-hover:text-white transition-colors duration-500" />
        </div>
        
        {/* Main content with improved typography and blue accents - reduced spacing */}
        <div className="relative z-20 space-y-4 px-6">
          <h3 className="text-lg font-medium text-white/95 group-hover:text-white 
          ...
          <p className="text-sm text-gray-300/90 leading-relaxed max-w-lg
            group-hover:text-gray-200 transition-colors duration-500">
            {description}
          </p>
        </div>

        {/* Corner accent with blue tint - smaller size */}
