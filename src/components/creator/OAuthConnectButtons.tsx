  ...
  const handleConnect = async (platform: string) => {
    try {
      ...
      if (platform === 'instagram') {
        window.location.href = `https://www.facebook.com/v19.0/dialog/oauth?client_id=1022001640046804&redirect_uri=https://functions.opensocials.net/functions/v1/auth-callback&response_type=code&scope=instagram_basic,pages_show_list,pages_read_engagement&state=01f8abb9-0c22-4adf-affd-d797bb2dd488`;
      } else {
