      ...
      <DialogContent className="max-w-none w-full h-full p-0 border-none bg-gradient-to-br from-gray-50 to-white overflow-hidden">
        <div className="flex flex-col items-center justify-center min-h-full px-4 py-8 sm:px-8">
          <div className="max-w-4xl w-full text-center space-y-12">
            <div className="space-y-4">
              ...
              <p className="text-xl sm:text-2xl text-gray-600 font-medium max-w-2xl mx-auto">
                Showcase your profile and land deals fast.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="group">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Top Brands</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Access campaigns from leading companies.
                  </p>
                </div>
              </div>
              <div className="group">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Quick Deals</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Get matched and start working in days.
                  </p>
                </div>
              </div>
              <div className="group">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Fair Pay</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Transparent terms and timely payments.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="absolute inset-0 -z-10 opacity-40">
            ...
            <div
              className="absolute bottom-0 right-1/4 w-96 h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"
