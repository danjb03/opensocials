          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-sm">Campaign Creation Time</span>
                <Badge variant="secondary">~5 minutes</Badge>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm">Creator Onboarding</span>
                <Badge variant="secondary">~10 minutes</Badge>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm">Deal Processing</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm">Analytics Refresh</span>
