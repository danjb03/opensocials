...
const CampaignCard: React.FC<CampaignCardProps> = ({ order, onClick }) => {
  ...
  return (
    <Card 
      className="hover:shadow-lg transition-all cursor-pointer overflow-hidden rounded-xl border-border hover:border-primary/20 bg-card"
      onClick={() => onClick(id)}
    >
      ...
      <CardContent className="p-5">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Badge variant="outline" className="bg-primary text-primary-foreground border-primary font-medium px-3 py-1">
